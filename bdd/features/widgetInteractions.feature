Feature: State Interactions
  ...
  Scenario: label drags update label position in state
    ...
    And the final state callback should match "data.state-minimal-one-point.500x500-after-core-label-drag" within 3
    ...
    And the final state callback should match "data.state-minimal-one-point.500x500-after-core-and-surface-label-drag" within 3
...
#    And Sleep 1
#    Then the final state callback should match "data.state-minimal-one-point.500x500-after-core-and-surface-label-drag" within 3
#    When I drag the circle by 100 x 100
#    And Sleep 3
#    Then the final state callback should match "data.state-minimal-one-point.500x500-base" within 3
